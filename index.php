    ...
    <div class="main_menu">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container box_1620">
          ...
          <a class="navbar-brand logo_h" href="index.php"><img src="img/favicon_myspbt2.png" alt=""></a>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav justify-content-end">
              ...
              <li class="nav-item"><a class="nav-link" href="#">Menu 1</a>
            ...
            <ul class="navbar-right">
              <li class="nav-item">
                <button class="button button-header bg">Daftar Sini</button>
              </li>
            </ul>
          </div> 
        </div>
